...
### P1 (High)
- [ ] Testing completo del flujo de navegación
- [ ] Verificar herencia de precios recursiva
...
## Next Tasks
1. Testing del flujo completo de navegación y orden
2. Verificar que admin_bulk_edit_folder aplica correctamente sortOrder recursivo
